...
\end{definition}
\begin{remark}
	This construction coincedes with the Drinfeld double of the Lie bialgebra \(\mathfrak{g}\), in the case where \(\mathfrak{g}\) is co-commutative \cite{quantum-groups}.
\end{remark}
