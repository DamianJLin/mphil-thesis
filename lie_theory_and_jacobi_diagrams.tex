...
% TODO: Make the following definitions only for Vect or whatever, then remark that they also apply in other Categories.
...
\begin{definition}
	...
	\begin{itemize}
		...
		\item an action of the symmetric group \(S_{n}\) on each \(\mathcal{O}(n)\)m
