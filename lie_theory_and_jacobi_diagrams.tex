...
\begin{definition}
	...
	\begin{itemize}
		\item a collection of sets, \(\{\mathcal{O}(n)\}_{n \in \mathbb{N}}\), with \(\mathcal{O}(n)\) known as the \textbf{\(n\)-ary operations},
...
\begin{example}
	...
	With this in mind, we can describe the \textbf{Lie operad} in a simple graphical presenation in terms of generators and relations:
	\[
		\mathcal{O}_{\text{Lie}}
		\quad
		=
