...
\begin{mdframed}
	State that this algebra is starting to look a lot like \(\mathcal{A}\). Find a nice way to say that Bar-Natan's conjecture is that they're isomorphic.
	
	Literature summary of tables of dimensions from metric Lie algebras. These disprove the conjecture, which leads into the next section.
\end{mdframed}
