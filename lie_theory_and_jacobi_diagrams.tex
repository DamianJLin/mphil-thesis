...
Indeed, we will see that from any metric Lie algebra, there is construction that associates to it a weight system. However this by itself is not enough to produce all weight systems, and to go further the construction can be extended to a generalised notion of metric Lie algebras: metric Lie algebra objects in an arbitrary symmetric monoidal category. But even this is not enough. However, the slightly more general notion of casimir Lie algebra objects in an arbitrary symmetric monoidal category does suffice to product all weight systems, and and operadic framework is introduced to prove this fact.
...
\begin{examples}
	\begin{enumerate}
		\item Let \(\mathbf{Vect}\) be the category of vector spaces and linear transformations. The symmetry natural isomorphism
			\[
				\begin{array}{rccc}
		...
		\item A \textbf{super vector space} is a \(\mathbb{Z}/2\mathbb{Z}\)-graded vector space \(V\) with the decomposition
			\[V = V_{0} \oplus V_{1}.\]
