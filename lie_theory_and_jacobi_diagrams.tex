...
Contracting the tensors corresponding to these diagrams then solving for a linear relation between them yields coefficients
\[
	\begin{array}{lll}
		-6
		W_{\mathfrak{g}_{2}}
