...
Note that the for the chord diagrams inside the algebra of Jacobi diagrams, the \ref{eq:STU} relations imply the \ref{eq:4T} relations, as
	\[
		...
		\ = \
		\adjustbox{valign=c}{\includegraphics[width=0.115\textwidth]{four_term_jacobi_diagram.pdf}}
		\ = \
...
\begin{remark}
	A note, maybe in remark env. on how these relations highlight the Lie algebraic properties of \(\mathcal{J}\).
\end{remark}

\begin{mdframed}
	The coproduct in \(\mathcal{J}\).
\end{mdframed}
