...
% Zsuzsi: If you untangle it for O=LIE, n=2, and m=(,) the Killing form, then the S_3-invariance written for the 3-cycle is the identity that ([x,y],z)=(x,[y,z]). In other words, this is fine, no typo. You could add this as an example or remark.
