...
\begin{proposition}
	The dual filtered bialgebra of \(\mathcal{K}\) is the dual filtered algebra of Vassiliev invariants.
\end{proposition}
...
This bialgebra strucutre on knots is heavily related to a bialgebra structure on chord diagrams. Recall the \ref{eq:4T} and \ref{eq:1T} relations from the previous section. Just like with the \ref{eq:diff} and \ref{eq:codiff} relations, instead of studying functions on chord diagrams satisfying \ref{eq:4T} and \ref{eq:1T}, we prefer to study functions on spaces quotiented by relations on the objects.
