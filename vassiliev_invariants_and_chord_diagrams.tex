...
\begin{definition}
	...
	This defines a multiplication operation \(\#: \mathcal{K}_{0} \otimes \mathcal{K}_{0} \to \mathcal{K}_{0}\).
\end{definition}

\begin{remark}
	The connected sum is a well-defined operation. It does not matter where along either knot the small arc was removed, all the reslts are ambient-isotopic.
\end{remark}
