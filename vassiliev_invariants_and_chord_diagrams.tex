...
The point of the fundamental theorem of Vassiliev invariants is that it allows us to establish a relationship between knots and chord diagrams, or equivalently, Vassiliev invariants and weight systems. Let's look at a theorem which is also sometimes called the fundamental theroem, though it says a little more than Theorem \ref{thm:fundamental-theorem-of-vassiliev-invariants}.

\begin{theorem}[Strong fundamental theorem]
	The algebra of weight systems is isomorphic to the associated graded algebra of the algebra of Vassiliev invariants,
	\[\bigoplus_{m = 0}^{\infty} \mathcal{W}_{m} \cong \bigoplus_{m = 0}^{\infty} \mathcal{V}_{m} / \mathcal{V}_{m + 1}\]
\end{theorem}
Which can be easily converted to a theorem in the dual setting.
\begin{theorem}[Strong fundamental theorem, dual]
	The algebra of chord diagrams is isomorphic to the associated graded algebra of the algebra of knots,
