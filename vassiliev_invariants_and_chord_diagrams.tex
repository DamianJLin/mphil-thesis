...
\begin{proof}
	We check those things we need to check: That the coproduct factors through the quoitents, that it's graded, and that the compatibility condition holds.
	...
	\end{itemize}
	but either way that term of the coproduct is killed.
